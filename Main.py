...
def UpdateNetTotals():
  vic_raw = pd.read_html("https://covidlive.com.au/report/daily-cases/vic", attrs={"class":"DAILY-CASES"})[0]
  nsw_raw = pd.read_html("https://covidlive.com.au/report/daily-cases/nsw", attrs={"class":"DAILY-CASES"})[0]
